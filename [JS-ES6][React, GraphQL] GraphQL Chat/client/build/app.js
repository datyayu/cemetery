...
/******/ 	var hotCurrentHash = "8138de4c55cdaf48cd1d"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatActions = __webpack_require__(190);
	...
	var _ChatInput = __webpack_require__(198);
	...
	var AppContainer = function (_React$Component) {
	  ...
	  _createClass(AppContainer, [{
	    ...
	    value: function render() {
	      ...
	      var inputContent = _props.inputContent;
	      var chatActions = _props.chatActions;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ChatInput2.default, { inputContent: inputContent,
	...
	function mapActionsToProps(dispatch) {
	  return { chatActions: (0, _redux.bindActionCreators)(chatActions, dispatch) };
	}
	
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapActionsToProps)(AppContainer);
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "container.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatActionsCreators = __webpack_require__(191);
	
	/* Generate a grapql request and return a promise from that request */
	var generateGraphQLRequest = function generateGraphQLRequest(query) {
	...
	function fetchMessages() {
	  var graphQLQuery = '{ messages { text, user { name } } }';
	
	  // Request all messages from server.
	  return function (dispatch) {
	    generateGraphQLRequest(graphQLQuery).then(function (response) {
	      return response.json();
	    }).then(function (response) {
	      if (response.errors) throw new Error(response.errors);
	
	      dispatch((0, _chatActionsCreators.updateMessages)(response.data.messages));
	    }).catch(console.log);
	  };
	};
	...
	function inputChange(event) {
	  ...
	  return function (dispatch) {
	    return dispatch((0, _chatActionsCreators.inputValueChange)(inputValue));
	  };
	}
	...
	function submitInput(event) {
	  ...
	  // Get text input value.
	  var inputElement = event.target.children[0];
	  ...
	  return function (dispatch) {
	    dispatch((0, _chatActionsCreators.inputSubmited)());
	    ...
	    generateGraphQLRequest(graphQLQuery).then(function (response) {
	      ...
	      dispatch((0, _chatActionsCreators.newMessage)(response.data.createMessage));
	    }).catch(console.log);
	  };
	}

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "chatActions.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.newMessage = exports.inputSubmited = exports.inputValueChange = exports.updateMessages = undefined;
	
	var _actionTypes = __webpack_require__(192);
	
	var updateMessages = exports.updateMessages = function updateMessages(messages) {
	  return {
	    type: _actionTypes.UPDATE_MESSAGES,
	...
	var inputValueChange = exports.inputValueChange = function inputValueChange(inputValue) {
	  return {
	...
	var inputSubmited = exports.inputSubmited = function inputSubmited() {
	  return { type: _actionTypes.INPUT_SUBMITED };
	};
	
	var newMessage = exports.newMessage = function newMessage(_ref2) {
	  var text = _ref2.text;
	  var user = _ref2.user;
	  return {
	    type: _actionTypes.NEW_MESSAGE,
	    message: {
	      text: text,
	      userName: user.name
	    }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "chatActionsCreators.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var INPUT_SUBMITED = exports.INPUT_SUBMITED = 'INPUT_SUBMITED';
	var NEW_MESSAGE = exports.NEW_MESSAGE = 'NEW_MESSAGE';
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "actionTypes.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageList = function MessageList(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    messages.map(function (message, idx) {
	      return _react2.default.createElement(_Message2.default, _extends({ key: idx }, message));
	    })
	  );
	};
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "MessageList.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Message.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatInput = function ChatInput(_ref) {
	  ...
	  var onInputSubmit = _ref.onInputSubmit;
	  return _react2.default.createElement(
	    "form",
	...
	ChatInput.propTypes = {
	  inputContent: _react.PropTypes.string.isRequired,
	  onInputChange: _react.PropTypes.func.isRequired,
	  onInputSubmit: _react.PropTypes.func.isRequired
	};
	
	exports.default = ChatInput;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ChatInput.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatReducer = __webpack_require__(201);
	...
	var store = createStoreWithMiddleware(_chatReducer2.default);
	
	exports.default = store;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "store.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var chatMessages = function chatMessages() {
	  ...
	  console.log(action);
	  switch (action.type) {
	    case _actionTypes.UPDATE_MESSAGES:
	    ...
	    case _actionTypes.INPUT_SUBMITED:
	      return Object.assign({}, state, {
	        inputContent: ''
	      });
	
	    case _actionTypes.NEW_MESSAGE:
	      return Object.assign({}, state, {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(193); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "chatReducer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
